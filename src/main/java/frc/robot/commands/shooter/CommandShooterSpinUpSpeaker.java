...
public class CommandShooterSpinUpSpeaker extends Command {
  ...
  public CommandShooterSpinUpSpeaker(SubsystemShooter subsystemShooter) {
  ...
  public boolean isFinished() {
    ...
    if (Math.abs(flyWheelSpeed - Constants.ShooterConstants.speakerShootSpeed) < Constants.ShooterConstants.speakerSpeedRange) {
      return true;
    } else {
      return false;
    }
